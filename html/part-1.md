...
Если значение совпадает с именем, то и оно не обязательно:
...
В коде HTML документа можно оставлять комментарии:
...
Всего различают четыре типа разметки:
...
Секционные элементы для деления документа на смысловые части.
